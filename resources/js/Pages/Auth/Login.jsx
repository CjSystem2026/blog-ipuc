        ...
        <div className="min-h-screen bg-[#FAF8F5] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
                ...
                <p className="mt-2 text-sm text-stone-500 max-w-xs mx-auto leading-relaxed">
                    Ingresa a tu cuenta de autor para redactar y edificar vidas a través de la palabra escrita.
                </p>
            </div>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
                <div className="bg-white py-8 px-6 sm:px-10 shadow-sm border border-stone-200/60 rounded-3xl">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                placeholder="autor@vocesdegracia.com"
                                required
                                autoFocus
                            />
                            {errors.email && (
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center space-x-2 text-sm text-stone-600 cursor-pointer select-none">
                                <input
                                    type="checkbox"
                                    checked={data.remember}
                                    onChange={(e) => setData('remember', e.target.checked)}
                                    className="rounded border-stone-300 text-amber-900 focus:ring-amber-800/20 h-4 w-4"
                                />
                                <span className="text-xs">Recordar mi cuenta</span>
                            </label>
                        </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-stone-100 flex flex-col items-center gap-3">
                        <Link href="/register" className="text-xs text-amber-900 hover:underline font-medium">
