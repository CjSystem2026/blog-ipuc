...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Nuevo Artículo</h2>
        </template>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="block">
                            <label class="flex items-center">
                                ...
                                <span class="ms-2 text-sm text-gray-600">Publicar inmediatamente</span>
                            </label>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-4 border-t pt-6">
                            ...
                            <PrimaryButton :disabled="form.processing">Crear Artículo</PrimaryButton>
                        </div>
                    </form>
                </div>
            </div>
