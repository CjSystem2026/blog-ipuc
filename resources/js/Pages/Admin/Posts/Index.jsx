        ...
        <AuthenticatedLayout
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">Administración de Artículos</h2>
                        ...
                        <div className="p-6 text-gray-900">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {posts.data.map((post) => (
                                        <tr key={post.id}>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <Link href={route('posts.edit', post.id)} className="text-indigo-600 hover:text-indigo-900 mr-4">Editar</Link>
                                    ...
                                    {posts.data.length === 0 && (
                                        <tr>
                                            <td colSpan="4" className="px-6 py-4 text-center text-gray-500">No hay artículos registrados.</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
